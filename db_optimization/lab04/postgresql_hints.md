...
| `Rows(t1 t2 #100)` | Формальний | Вказує очікувану кількість рядків у результаті JOIN | Цей хінт використовується для впливу на вибір оптимального способу виконання JOIN. Він встановлює прогнозовану кількість рядків у результаті об'єднання таблиць t1 та t2. Це може бути корисно, якщо PostgreSQL неправильно оцінює розмір вибірки, що призводить до неоптимального вибору алгоритму JOIN.|
...
### Категорія: enable_*
Ну чисто щось включати/виключати
...
### Категорія: cost
По суті, змінює формули розрахунку Cost
...
### Категорія: memory
Різні хінти для керуванням пам'яттю
...
Поради до структури ваших запитів (їх взагалі може бути безліч)
...
А ці допомагають працювати зі статистикою
